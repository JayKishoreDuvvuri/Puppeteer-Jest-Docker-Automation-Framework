...
import { blackColourImageUpdated, blueColourImageUpdated, itemSelected, navigateUrl, orangeColourImageUpdated, title, yellowColourImageUpdated } from '../utils/locators';
...
describe('Toggle between the colours of the Product', () => {
    ...
    it('Navigate to Landing Page', async () => {
        ...
        expect(await ProductPage.getTitle()).toEqual(title1);
